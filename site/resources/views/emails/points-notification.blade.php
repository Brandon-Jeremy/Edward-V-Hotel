            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border: 2px solid gold; background-color: #2e2626;">
                    ...
                    <tr>
                        <td style="padding: 40px; font-size: 18px; line-height: 1.5em; text-align: center;">
                            ...
                            <p style="margin-bottom: 30px;color:whitesmoke">Additional points were credited to your account. Please be sure to check out our website to see what rewards you can purchase with your current points</p>
                            <p style="color:whitesmoke"></p>
                            <p style="margin-bottom: 30px; background-color: #222f80; color: #fff; padding: 10px 20px; text-decoration: none; border-radius: 10px;">Current Points: {{ $pointsmailData['points'] }} </p>
