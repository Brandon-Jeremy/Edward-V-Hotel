            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border: 2px solid gold; background-color: #2e2626;">
                    ...
                    <tr>
                        <td style="padding: 40px; font-size: 18px; line-height: 1.5em; text-align: center;">
                            ...
                            <p style="margin-bottom: 30px;color:whitesmoke">Thank you for choosing to stay at Edward V Hotel. We hope you enjoyed your stay and we look forward to welcoming you back soon.</p>
                            <p style="color:whitesmoke">Please take a few minutes to share your feedback with us by clicking on the link below:</p>
                            <p style="margin-bottom: 30px;"><a href="#" style="background-color: #222f80; color: #fff; padding: 10px 20px; text-decoration: none; border-radius: 10px;">Provide Feedback</a></p>
