            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border: 2px solid gold; background-color: #2e2626;">
                    ...
                    <tr>
                        <td style="padding: 40px; font-size: 18px; line-height: 1.5em; text-align: center;">
                            ...
                            <p style="margin-bottom: 30px;color:whitesmoke">A giftcode was just created with the following value: {{$mailData['value']}}</p>
                            <p style="color:whitesmoke">The redeemable token ID for the giftcard is:</p>
                            <p style="margin-bottom: 30px;"><a style="background-color: #222f80; color: #fff; padding: 10px 20px; text-decoration: none; border-radius: 10px;">{{$mailData['token']}}</a></p>
