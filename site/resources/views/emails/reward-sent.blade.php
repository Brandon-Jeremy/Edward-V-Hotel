            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border: 2px solid gold; background-color: #2e2626;">
                    ...
                    <tr>
                        <td style="padding: 40px; font-size: 18px; line-height: 1.5em; text-align: center;">
                            ...
                            <p style="margin-bottom: 30px;color:whitesmoke">You have received a gift!</p>
                            <p style="color:whitesmoke">Please take a few minutes to take a look at your received gift! The following link will provide you with a quick way to get to our website!</p>
                            <p style="margin-bottom: 30px;"><a href="#" style="background-color: #222f80; color: #fff; padding: 10px 20px; text-decoration: none; border-radius: 10px;">Check your gift now!</a></p>
