            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border: 2px solid gold; background-color: #2e2626;">
                    ...
                    <tr>
                        <td style="padding: 40px; font-size: 18px; line-height: 1.5em; text-align: center;">
                            <p style="margin-bottom: 30px; color:whitesmoke">Message received from Hotel Guest,</p>
                            <p style="margin-bottom: 30px;color:whitesmoke">Guest's email: {{ $mailData['email'] }}<br><br>Message from guest:</p>
                            <p style="color:whitesmoke"></p>
                            <p style="margin-bottom: 30px; background-color: #222f80; color: #fff; padding: 10px 20px; text-decoration: none; border-radius: 10px;"> {{ $mailData['message'] }} </p>
                        </td>
                    </tr>
                    <tr>
