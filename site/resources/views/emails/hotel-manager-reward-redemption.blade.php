            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border: 2px solid gold; background-color: #2e2626;">
                    ...
                    <tr>
                        <td style="padding: 40px; font-size: 18px; line-height: 1.5em; text-align: center;">
                            <p style="margin-bottom: 30px; color:whitesmoke">To Hotel Managers,</p>
                            <p style="margin-bottom: 30px;color:whitesmoke">A reward for an airport chauffeur was redeemed</p>
                            <p style="color:whitesmoke">The redemption info is:</p>
                            <p style="margin-bottom: 30px;"><a style="background-color: #222f80; color: #fff; padding: 10px 20px; text-decoration: none; border-radius: 10px;">{{$mailData['first_name']}} {{$mailData['last_name']}} {{$mailData['date_from']}}</a></p>
