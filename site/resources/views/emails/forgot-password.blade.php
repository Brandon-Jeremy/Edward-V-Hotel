            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border: 2px solid gold; background-color: #2e2626;">
                    ...
                    <tr>
                        <td style="padding: 40px; font-size: 18px; line-height: 1.5em; text-align: center;">
                            ...
                            <p style="margin-bottom: 30px;color:whitesmoke">A request was just made from your account to change your password</p>
                            <p style="color:whitesmoke">The button below will take you to our website where you can update your password:</p>
                            <p style="mBook a roomargin-bottom: 30px;"><a href="{{ $mailData['url'] }}" style="background-color: #222f80; color: #fff; padding: 10px 20px; text-decoration: none; border-radius: 10px;">Change Password</a></p>
                            <p style="color:whitesmoke">If this was not you, ignore this email and do not press the change password button!</p>
                        </td>
                    </tr>
                    <tr>
