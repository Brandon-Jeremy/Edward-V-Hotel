            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border: 2px solid gold; background-color: #2e2626;">
                    ...
                    <tr>
                        <td style="padding: 40px; font-size: 18px; line-height: 1.5em; text-align: center;">
                            ...
                            <p style="margin-bottom: 30px;color:whitesmoke">Thank you for choosing to stay at Edward V Hotel.You are receiving this email as you have requested to be added to the waiting list to be updated when a room becomes available.</p>
                            <p style="color:whitesmoke">The button below will link you our website where you can book a room:</p>
                            <p style="mBook a roomargin-bottom: 30px;"><a href="#" style="background-color: #222f80; color: #fff; padding: 10px 20px; text-decoration: none; border-radius: 10px;">Book a room</a></p>
